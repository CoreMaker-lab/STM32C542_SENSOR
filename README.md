...
- **STM32C542_Project1**:STM32C542开发(1)----点亮LED
- **CSDN Blog**:[https://blog.csdn.net/qq_24312945/article/details/161573353](https://blog.csdn.net/qq_24312945/article/details/161573353)
...
这里通过配置LED输出进行简单测试。
STM32C542 & SENSOR is an evaluation kit based on the STM32C5 series microcontroller. The microcontroller is manufactured using a 40 nm process, offering faster FLASH access, higher performance, and lower power consumption. In addition, the kit provides rich interfaces and peripherals, as well as SENSOR series connector interfaces, offering developers a convenient and flexible development environment.

In this example, a simple test is performed by configuring the LED output.



- **STM32C542_Project2**:STM32C542开发(2)----BOOT_SEL设置
- **CSDN Blog**:[https://blog.csdn.net/qq_24312945/article/details/161573484](https://blog.csdn.net/qq_24312945/article/details/161573484)
...
- **STM32C542_Project3**:STM32C542开发(3)----配置串口打印
- **CSDN Blog**:[https://blog.csdn.net/qq_24312945/article/details/161613890](https://blog.csdn.net/qq_24312945/article/details/161613890)
